...
function Testimonials() {
  ...
  return (
    <section id="testimonials" className="relative overflow-hidden bg-gradient-to-b from-card to-surface py-24">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-12">
          <div className="overflow-hidden rounded-[2.5rem] border border-line bg-card p-8 shadow-lux sm:p-12">
          ...
          <div className="mt-10 grid grid-cols-3 gap-4 text-center">
            {[
              ...
              <div key={item.label} className="rounded-2xl border border-line bg-card px-4 py-5 shadow-sm">
