...
function DateNightKits() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-accent-soft via-card to-surface py-24">
        ...
        {loading ? (
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="h-[420px] animate-pulse rounded-[2rem] border border-line bg-card" />
            ))}
          </div>
        ) : (
          <div className="relative mt-14">
            <button
              ...
              className="absolute left-2 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-line bg-card text-accent shadow-lux transition hover:bg-accent hover:text-white"
            >
            ...
            <button
              ...
              className="absolute right-2 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-line bg-card text-accent shadow-lux transition hover:bg-accent hover:text-white"
            >
                ...
                <FadeIn key={kit._id} delay={0.06 * i}>
                  ...
                  >
                    ...
                    <span className="absolute bottom-5 left-5 right-5 flex items-center justify-between gap-3">
                      ...
                      <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-card text-accent shadow-lg transition duration-300 group-hover:bg-accent group-hover:text-white">
