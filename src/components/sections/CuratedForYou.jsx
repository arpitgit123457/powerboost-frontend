        ...
        <div className="flex flex-col items-end justify-between gap-6 md:flex-row md:items-end">
          ...
          <FadeIn delay={0.1}>
            <Link
              ...
              className="group inline-flex items-center gap-2 rounded-full border-2 border-accent bg-card px-6 py-3 text-sm font-bold text-accent transition hover:bg-accent hover:text-white"
            >
              View All
