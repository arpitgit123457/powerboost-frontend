...
function Navbar({ onSearchOpen }) {
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 bg-card transition-shadow duration-300 ${
        ...
        <div className="flex items-center gap-2">
          ...
          {user ? (
            <div className="relative hidden sm:block" ref={userMenuRef}>
              ...
              {userMenuOpen && (
                <div className="absolute right-0 top-full z-50 mt-2 w-64 overflow-hidden rounded-2xl border border-line bg-card shadow-lux">
