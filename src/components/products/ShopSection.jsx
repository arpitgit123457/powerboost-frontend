    ...
    <section id="shop" className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      <div className="relative mt-8">
        <button
          ...
          className="absolute -left-1 top-1/2 z-10 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-line bg-card text-ink shadow-lg transition hover:border-accent hover:text-accent md:flex"
        >
        ...
        <button
          ...
          className="absolute -right-1 top-1/2 z-10 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-line bg-card text-ink shadow-lg transition hover:border-accent hover:text-accent md:flex"
        >
