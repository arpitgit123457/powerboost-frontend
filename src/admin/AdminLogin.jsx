...
function AdminLogin() {
  ...
  const [form, setForm] = useState({ email: 'admin@powerbooster.com', password: 'admin123' })
  ...
  const field =
    'w-full rounded-xl border border-line bg-surface px-4 py-3 text-sm text-ink outline-none transition placeholder:text-mist/60 focus:border-accent/60 focus:bg-card'

  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-surface to-card p-4">
      <div className="w-full max-w-md">
        <div className="rounded-3xl border border-line bg-card p-8 shadow-lux">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-mist">
              Sign in to manage Power Booster storefront
            </p>
          </div>
            ...
            <label className="block">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@powerbooster.com"
                  autoComplete="off"
          ...
          <div className="mt-5 rounded-xl bg-accent-soft px-4 py-3 text-center text-xs text-mist">
            <span className="font-bold text-accent">Demo admin:</span> admin@powerbooster.com / admin123
          </div>
        </div>
