...
const inputCls =
  'w-full rounded-xl border border-line bg-surface py-3 pl-11 pr-11 text-sm font-medium text-ink outline-none transition placeholder:text-mist/60 focus:border-accent/60 focus:bg-card'
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-surface px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-4 text-center">
          <Link to="/" className="flex items-center gap-2" aria-label="Power Booster home">
            ...
            <span className="text-2xl font-extrabold tracking-tight text-ink">
              Power<span className="text-accent">Booster</span>
            </span>
          </Link>
        ...
        <div className="overflow-hidden rounded-3xl border border-line bg-card shadow-lux">
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-accent/30 bg-accent-soft/60 px-5 py-4">
          ...
          <p className="mt-1 text-sm text-ink">
            Email: <span className="font-bold">admin@powerbooster.com</span> · Password:{' '}
