...
const contactInfo = [
  {
    icon: Mail,
    title: 'Email Us',
    value: 'contact@powerbooster.com',
...
const details = [
  {
    ...
    label: 'Email Address',
    value: 'contact@powerbooster.com',
    href: 'mailto:contact@powerbooster.com',
  },
  {
    icon: Phone,
    label: 'Phone Number',
...
function Contact() {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-b from-surface to-card pb-20 pt-32 sm:pt-36">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-3">
            {contactInfo.map((info, i) => (
              <motion.div
                ...
                className="group flex items-start gap-5 rounded-3xl border border-line bg-card p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-accent/30 hover:shadow-lux"
              >
              ...
              <form onSubmit={submit} className="mt-8 grid gap-5 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-line bg-surface px-5 py-3.5 text-sm text-ink outline-none transition placeholder:text-mist/60 focus:border-accent/60 focus:bg-card"
                  />
                </div>
                <div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-2xl border border-line bg-surface px-5 py-3.5 text-sm text-ink outline-none transition placeholder:text-mist/60 focus:border-accent/60 focus:bg-card"
                  />
                </div>
                <div className="sm:col-span-2">
                  <button
          ...
          >
            ...
            <div className="mt-8 space-y-4">
              {details.map((item) => {
                ...
                const base = 'flex items-center gap-5 rounded-3xl border border-line bg-card p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-accent/30 hover:shadow-lux'
                return item.href ? (
