...
function ProductPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-surface to-card py-16 pt-28 sm:pt-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-2">
          <FadeIn>
            <div className="group relative overflow-hidden rounded-[2rem] border border-line bg-card shadow-sm">
              {product.image ? (
                <img
                  src={product.image}
                  alt={product.name}
          ...
          <FadeIn delay={0.1}>
            <div className="flex h-full flex-col">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="rounded-full border border-line bg-card px-4 py-2 text-xs font-bold text-ink">
                  ✓ Discreet packaging
                </span>
                <span className="rounded-full border border-line bg-card px-4 py-2 text-xs font-bold text-ink">
                  ✓ Genuine products
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {perks.map((perk) => (
                  <div key={perk.label} className="flex items-center gap-3 rounded-2xl border border-line bg-card p-4">
