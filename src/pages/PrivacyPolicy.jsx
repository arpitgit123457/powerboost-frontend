...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      'Any personal/sensitive information will not be disclosed by Power Booster to any third party without prior permission.',
    ],
  },
  {
    title: 'Cookies',
    body: [
      'Power Booster uses "cookies" to track usage patterns, traffic trends, and user behavior, as well as to record other information from the website. For certain services provided on this website, cookies allow Power Booster and/or its group companies/affiliates to save information locally so that you will not have to re-enter it the next time you visit. Many content adjustments and customer service improvements are made based on the data derived from cookies. The information we collect from cookies will not be used to create profiles of users and will only be used in aggregate form.',
      ...
      'If the User uses any of the sharing features that may be offered by the digital assets, the User’s friend’s email address will not be retained on Power Booster Website or used in any way by Power Booster or its group companies/affiliates.',
    ],
  },
]
...
function PrivacyPolicy() {
  return (
    <PolicyPage
      ...
      intro="Your right to privacy is of paramount importance to us. This policy explains how Power Booster collects, uses and protects your information."
