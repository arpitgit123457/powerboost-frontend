...
const inputCls =
  'w-full rounded-xl border border-line bg-surface py-3 pl-11 pr-4 text-sm font-medium text-ink outline-none transition placeholder:text-mist/60 focus:border-accent/60 focus:bg-card'
  ...
  if (placed) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-surface px-4 py-24">
        ...
        >
          <div className="overflow-hidden rounded-3xl border border-line bg-card text-center shadow-lux">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <form onSubmit={placeOrder} className="mt-8 grid gap-8 lg:grid-cols-5">
          <div className="space-y-6 lg:col-span-3">
            <section className="rounded-3xl border border-line bg-card p-6 shadow-sm sm:p-7">
              <div className="flex items-center gap-3">
            ...
            <section className="rounded-3xl border border-line bg-card p-6 shadow-sm sm:p-7">
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                {paymentOptions.map((opt) => {
                  ...
                  return (
                    ...
                    >
                      <span className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl transition ${active ? 'bg-accent text-white' : 'bg-card text-mist border border-line'}`}>
              ...
              {showPayInfo && (
                <div className="mt-3 overflow-hidden rounded-2xl border border-line bg-surface">
                  <div className="flex flex-wrap gap-2 border-b border-line bg-card px-4 py-3">
                    {payChips.map((chip) => (
                      <span
                        key={chip}
                    ...
                    {payMethods.map((method) => {
                      ...
                      return (
                        <div key={method.title} className="flex items-start gap-3 px-4 py-4">
                          <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-card text-accent shadow-sm">
                  ...
                  <div className="border-t border-line bg-accent-soft/50 px-5 py-4 text-xs leading-relaxed text-mist">
                    ...
                    <p className="mt-2">
                      ...
                      <span className="font-bold text-ink">"Power Booster"</span>, and sent to:
                    </p>
                    <p className="mt-2 font-bold text-ink">
                      Power Booster Pvt. Ltd.
                      <br />
          ...
          <aside className="lg:col-span-2">
            <div className="sticky top-24 rounded-3xl border border-line bg-card p-6 shadow-lux sm:p-7">
