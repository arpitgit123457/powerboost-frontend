...
const story = [
  'Power Booster was considered to be one of the Best and Oldest Ayurvedic Clinic in India. Power Booster was started with to treat poor and needy patients with the aid of safe, effective and affordable Ayurvedic medicines.',
  'Power Booster is famous for practicing Ayurveda, Yoga and other performing Arts. The name and fame of Ayurveda was synonymous with India\u2019s heritage and culture. Legendaries from all over the world and has giving Ayurvedic Treatment by Oldest and best Ayurvedic Formulas.',
  'The Power Booster is famous for its Oldest And Effective Style of Ayurvedic Formulas. Power Booster\u2019s name and fame continue, and it has contributed in its own way in preserving and nurturing the tremendous and rich heritage which is unique to India.',
  'Ayurveda is a 5000 year old Science of health care and herbal treatment with the help of ayurvedic medicine. Ayurveda, is highly effective in common and complicated ailments, assures long term relief and has no side effects. Ayurvedic treatment is practiced here for time immemorial and millions of people have availed this facility. Ayurvedic treatment is carried out in a special and authentic style called \u201cPower Booster\u201d.',
]
...
const heritage = [
  ...
  {
    icon: Wand2,
    title: 'Power Booster Style',
    desc: 'Ayurvedic treatment is carried out in a special and authentic style called \u201cPower Booster\u201d \u2014 practiced here since time immemorial.',
    color: 'from-green-500 to-emerald-400',
  },
  {
    icon: Activity,
    title: 'Ayurveda, Yoga & the Arts',
    desc: 'Beyond medicines, Power Booster is renowned for practicing Ayurveda, Yoga and other performing arts rooted in India\u2019s heritage.',
  ...
  return (
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative overflow-hidden rounded-[2.5rem] border border-line bg-card p-3 shadow-lux">
                <img
              ...
              <div className="absolute -right-4 -top-4 flex items-center gap-2 rounded-2xl border border-line bg-card px-5 py-3 shadow-lux sm:-right-6">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="grid grid-cols-2 gap-4 rounded-3xl border border-line bg-card p-8 shadow-lux lg:grid-cols-4 lg:gap-8">
            {stats.map((stat) => (
          ...
          <FadeIn delay={0.1}>
            <div className="space-y-5">
              {story.slice(2).map((para, i) => (
                <div
                  key={i}
                  className="rounded-3xl border border-line bg-card p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-accent/30 hover:shadow-lux"
                >
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-card via-surface to-card py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-mist">
              Power Booster has contributed in its own way in preserving and nurturing the
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {heritage.map((item, i) => (
              <FadeIn key={item.title} delay={0.06 * i}>
                <div className="group relative h-full overflow-hidden rounded-3xl border border-line bg-card p-8 shadow-sm transition duration-300 hover:-translate-y-2 hover:border-accent/30 hover:shadow-lux">
          ...
          <div className="relative mt-16 overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-accent via-amber-700 to-orange-800 px-6 py-16 text-center text-white shadow-2xl shadow-accent/30 sm:px-16 sm:py-20">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-4 max-w-xl text-base text-amber-50/90 sm:text-lg">
                ...
                Power Booster formulas.
              </p>

              <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
                <Link
                  to="/products"
                  className="group inline-flex items-center gap-2 rounded-full bg-card px-8 py-4 text-sm font-black uppercase tracking-wide text-accent shadow-xl transition hover:bg-amber-50"
                >
                  Shop Now
                  <ArrowRight className="h-4 w-4 transition group-hover:translate-x-1" />
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 rounded-full border-2 border-white/60 px-8 py-4 text-sm font-bold text-white transition hover:bg-card hover:text-accent"
                >
